...
use OrientDB\Databases\DatabaseList;
use OrientDB\Protocols\Common\TransportInterface;

/**
 * Class Client
 *
 * @property \OrientDB\Databases\DatabaseList $databases
 *
 * @package OrientDB
 */
class Client implements ConfigurableInterface, MagicInterface
{
     ...
     * Sets the transport
     *
     * @param \OrientDB\Protocols\Common\TransportInterface $transport
     *
     ...
     * Gets the transport
     *
     * @return \OrientDB\Protocols\Common\TransportInterface
     */
    ...
    protected function createTransport($transport = null)
    {
        if (is_string($transport)) {
            ...
            if (isset($transport['class'])) {
                ...
                $className = 'OrientDB\Protocols\Binary\Transport';
            }
     ...
     *
     * @return \OrientDB\Databases\DatabaseList
     */
